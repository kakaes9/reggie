...
import com.kakase9.reggietakeout.dto.DishDto;
...
import com.kakase9.reggietakeout.service.DishFlavorService;
...
public class DishController {
    ...
    public R<List<DishDto>> list(Dish dish) {
        ...
        //动态构造key
        String key = "dish_" + dish.getCategoryId() + "_" + dish.getStatus();//dish_1397844263642378242&_1
